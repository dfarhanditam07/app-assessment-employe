export const questions = [
  {
    id: 1,
    text: 'Anggota tim akhir-akhir ini tidak merespons pendekatan Anda yang bersahabat. Mereka tampak tidak peduli, dan kinerjanya menurun drastis.',
    options: {
  ...
  {
    id: 2,
    text: 'Kinerja tim sedang membaik. Anda sudah memastikan mereka mengetahui tugas dan standar kerja yang diharapkan.',
    options: {
  ...
  {
    id: 3,
    text: 'Tim Anda sedang menghadapi masalah yang tidak bisa mereka selesaikan sendiri. Biasanya Anda membiarkan mereka bekerja mandiri, dan selama ini hubungannya baik.',
    options: {
  ...
  {
    id: 4,
    text: 'Anda ingin membuat perubahan. Tim Anda punya kinerja bagus dan terbuka terhadap perubahan.',
    options: {
  ...
  {
    id: 5,
    text: 'Kinerja tim terus menurun dan mereka tampak tidak peduli dengan target. Dulu, menjelaskan ulang peran mereka cukup membantu, tapi sekarang mereka terus perlu diingatkan.',
    options: {
  ...
  {
    id: 6,
    text: 'Anda menggantikan pemimpin sebelumnya yang sangat mengontrol tim. Sekarang tim sudah berjalan baik. Anda ingin mempertahankan performa, tapi juga ingin lebih membangun hubungan antar anggota.',
    options: {
  ...
  {
    id: 7,
    text: 'Anda sedang mempertimbangkan perubahan struktur kerja. Tim sudah terbukti fleksibel dan mereka punya banyak ide bagus untuk perbaikan.',
    options: {
  ...
  {
    id: 8,
    text: 'Hubungan di tim sangat baik dan mereka bekerja dengan baik. Tapi Anda merasa belum memberikan arahan yang cukup jelas.',
    options: {
  ...
  {
    id: 9,
    text: 'Anda ditugaskan memimpin kelompok studi yang belum menyelesaikan tugas penting. Mereka tidak fokus dan cenderung menjadikan pertemuan sebagai ajang sosial.',
    options: {
  ...
  {
    id: 10,
    text: 'Setelah satu anggota keluar, Anda mendefinisikan ulang peran tim. Tapi mereka tidak menanggapi atau beradaptasi.',
    options: {
  ...
  {
    id: 11,
    text: 'Anda menjadi pemimpin baru. Tim sebelumnya cukup mandiri dan hubungan mereka sangat baik.',
    options: {
  ...
  {
    id: 12,
    text: 'Muncul konflik internal di tim. Sebelumnya mereka sangat solid, berprestasi, dan semua punya kompetensi tinggi.',
    options: {
